    ...
    <Container className="text-center lg:pt-24">
      ...
      <div className="sm:mt-18 mx-auto mt-16 grid max-w-2xl grid-cols-2 sm:grid-cols-4 lg:mt-20 gap-4 sm:gap-16 lg:max-w-none">
        <div className="border border-slate-500 rounded-2xl flex flex-col bg-slate-100 w-full aspect-[4/3] sm:px-12 px-4 pt-4">
          <span
            className={`sm:my-3 text-xl font-semibold text-indigo-900 animate-[counter_3s_ease-out_forwards] tabular-nums [counter-set:_num_var(--num-partners)] before:content-[counter(num)]`}
          >
        ...
        <div className="border border-slate-500 rounded-2xl flex flex-col bg-slate-100 w-full aspect-[4/3] sm:px-12 px-4 pt-4">
          <span
            className={`sm:my-3 text-xl font-semibold text-indigo-900 animate-[counter_3s_ease-out_forwards] tabular-nums [counter-set:_num_var(--num-words)] before:content-[counter(num)]`}
          >
        ...
        <div className="border border-slate-500 rounded-2xl flex flex-col bg-slate-100 w-full aspect-[4/3] sm:px-12 px-4 pt-4">
          <span
            className={`sm:my-3 text-xl font-semibold text-indigo-900 animate-[counter_3s_ease-out_forwards] tabular-nums [counter-set:_num_var(--num-satisfaction)] before:content-[counter(num)]`}
          >
